...
export function read(): Array<InterfaceTarefa> {
...
function update(
  id: UUID,
  parteDoObjeto: Partial<InterfaceTarefa>
): InterfaceTarefa {
  let updateObjeto;
  const objetos = read();
...
// clearDB();
// create("Primeiro ObjetoTarefa"); // primeiro objeto

// const secundoObject = create("Segundo ObjetoTarefa"); // segundo Objeto

// // trocando um o conteudo do terceiro pelo segundo.
// const terceiroObjetoTarefa = create("terceiro ObjetoTarefa"); // terceiro objeto

// irá deletar o segundo objeto
